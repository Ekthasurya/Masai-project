...
const DressesSingle = () => {
  const { Id } = useParams();
  const product = skirts.find((item) => item.id === parseInt(Id));
  ...
  return (
    <Flex
      direction={{ base: 'column', md: 'row' }}  // Stacked on small screens, row on medium and larger
