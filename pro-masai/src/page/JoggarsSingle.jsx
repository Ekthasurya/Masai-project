...
import { Joggars } from '../Data/joggars';

const JoggarsSingle = () => {
  const { Id } = useParams();
  const product = Joggars.find((item) => item.id === parseInt(Id));
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        mb={{ base: 4, md: 0 }} // Adds margin bottom on mobile
        border="2px solid"
        borderRadius="md"
        overflow="hidden"
        shadow="md"
