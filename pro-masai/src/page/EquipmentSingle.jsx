...
const EquipmentSingle = () => {
  const { Id } = useParams();
  const product = equipment.find((item) => item.id === parseInt(Id));
  ...
  return (
    <Flex
      direction={{ base: 'column', md: 'row' }} // Stacks vertically on mobile, horizontally on medium and larger screens
    ...
    >
      ...
      <Box
        ...
        mb={{ base: 4, md: 0 }} // Adds margin bottom on mobile for spacing
        border="2px solid"
        borderRadius="md"
        overflow="hidden"
        shadow="md"
