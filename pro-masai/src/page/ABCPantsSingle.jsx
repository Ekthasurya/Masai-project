...
const ABCPantsSingle = () => {
  const { Id } = useParams();
  const product = AbcPants.find((item) => item.id === parseInt(Id));
  ...
  return (
    ...
    >
      ...
      <Box textAlign="center" mt={{ base: 6, md: 0 }} ml={{ base: 0, md: 8 }}>
        ...
        {/* Product Description */}
        <Box marginTop={8}>
          <Text fontSize={{ base: 'lg', md: '2xl' }} fontWeight={500}>Why we make this?</Text>
