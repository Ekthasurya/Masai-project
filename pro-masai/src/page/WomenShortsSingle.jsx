...
import { womenShorts } from '../Data/womenShorts';

const WomenShortsSingle = () => {
  const { Id } = useParams();
  const product = womenShorts.find((item) => item.id === parseInt(Id));
...
export default WomenShortsSingle;
